...
def iterate_json_file(json_file):
    ...
    for key, value in json_file.items():
        if key == 'data':
            ...
            raise Exception('json object must start with key "data"')
    return result
...
def iterate_findings(finding_object):
    ...
    for key, value in finding_object.items():
        if key == 'findings':
            ...
            raise Exception('class object must start with key "findings"')
    return result
